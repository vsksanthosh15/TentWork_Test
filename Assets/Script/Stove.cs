...
public class Stove : MonoBehaviour {
    ...
    public void OnCooking(Ingredients ingredient) {
        ...
        if(ingredient== null || ingredient.GetIngredientData.IngredientType != IngredientType.Meet || currentIngredient != null) return;
        ...
        StopAllCoroutines();
        StartCoroutine(StartCooking(GameManager.Instance.GetCookingTime));
    }
